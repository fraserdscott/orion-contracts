...
export interface SquareComponentInterface extends utils.Interface {
  contractName: "SquareComponent";
  functions: {
    ...
    "set(uint256,(int256,int256,int256,int256))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, ColliderStruct]
  ): string;
  encodeFunctionData(
...
export interface SquareComponent extends BaseContract {
  contractName: "SquareComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SquareComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((int256,int256,int256,int256))"(
      value: ColliderStruct,
      overrides?: CallOverrides
    ): Promise<[BigNumber[]]>;
    ...
    "set(uint256,(int256,int256,int256,int256))"(
      entity: BigNumberish,
      value: ColliderStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
